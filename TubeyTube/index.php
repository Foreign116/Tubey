	...
	<div class="row">
				...
				<form >
					<div class="row">
						<div class="input-field col s6">
							<input placeholder="Video URL" id="videoUrl" type="text" class="validate white-text flow-text"><br>
							<button class="waves-effect waves-light btn white black-text flow-text">Enter</button>
						</div>
					</div>
				</form>
			</div>
		...
		<div class="col s4">
			<div id="queue" >
				...
				<ul  id="queueList"></ul>
				<button class=" waves-effect waves-light btn white black-text flow-text" id="skip">Skip</button>
